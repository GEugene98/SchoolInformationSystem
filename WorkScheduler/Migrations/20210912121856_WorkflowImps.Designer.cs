...
namespace WorkScheduler.Migrations
{
    ...
    [Migration("20210912121856_WorkflowImps")]
    partial class WorkflowImps
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkScheduler.Models.Shared.School", b =>
                {
                    ...
                    b.Property<string>("IncomingDocumentTypesJSON");

                    b.Property<string>("IncomingWorkflowChecklist");

                    b.Property<string>("Name");

                    b.Property<string>("OutgoingDocumentTypesJSON");

                    b.Property<string>("OutgoingWorkflowChecklist");
            ...
            modelBuilder.Entity("WorkScheduler.Models.Workflow.IncomingDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WorkScheduler.Models.Workflow.IncomingDocumentFile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("IncomingDocumentFiles");
                });

            modelBuilder.Entity("WorkScheduler.Models.Workflow.OutgoingDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WorkScheduler.Models.Workflow.OutgoingDocumentFile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("OutgoingDocumentFiles");
                });
            ...
            modelBuilder.Entity("WorkScheduler.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("WorkScheduler.Models.Workflow.IncomingDocument", "IncomingDocument")
                        .WithMany("Tickets")
                        .HasForeignKey("IncomingDocumentId");

                    b.HasOne("WorkScheduler.Models.Workflow.OutgoingDocument", "OutgoingDocument")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("WorkScheduler.Models.Workflow.IncomingDocumentFile", b =>
                {
                    b.HasOne("WorkScheduler.Models.Shared.File", "File")
                        .WithMany("IncomingDocumentFiles")
                        .HasForeignKey("FileId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("WorkScheduler.Models.Workflow.OutgoingDocumentFile", b =>
                {
                    b.HasOne("WorkScheduler.Models.Shared.File", "File")
                        .WithMany("OutgoingDocumentFiles")
                        .HasForeignKey("FileId")
                        .OnDelete(DeleteBehavior.Cascade);
